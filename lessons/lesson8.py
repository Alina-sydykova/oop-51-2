...
def get_user_with_highest_grade():
    cursor.execute(
        '''SELECT namr, subject, grade'
           FROM users
...
get_user_with_highest_grade()


#Views (Представление)
def create_young_users_view():
    cursor.execute('''
    CREATE VIEW IF NOT EXIST young_users AS
